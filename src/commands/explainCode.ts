...
export async function explainCodeCommand(
    ...
    const actionName = PromptService.getActionDisplayName(AIAction.EXPLAIN_CODE);

    try {
        logger.info('Explain Code command triggered');
        ...
        vscode.window.showInformationMessage('AI Assistant: Explanation complete.');
