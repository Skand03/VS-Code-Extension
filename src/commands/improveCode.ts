...
export async function improveCodeCommand(
    ...
    try {
        ...
        const prompt = PromptService.generatePrompt(AIAction.IMPROVE_CODE, selection, undefined, sidebarProvider.getUiLanguage());
        logger.debug('Prompt generated for Improve Code');
